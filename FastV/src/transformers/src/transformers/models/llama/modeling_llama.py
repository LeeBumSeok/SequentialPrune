                ...
                if USE_FAST_V and FASTV_INPLACE:
                    ...
                    if idx < AGG_LAYER:
                        ...
                        top_attention_rank_index = (
                            last_layer_attention_avg_last_tok_image.topk(ATTENTION_RANK).indices + SYS_LENGTH
                        )
                        # keep index
                        keep_indexs = torch.cat(
                            (
                                ...
                                top_attention_rank_index,
                                torch.arange(SYS_LENGTH + IMAGE_TOKEN_LENGTH, seq_length_with_past, device=device),
                            )
                        )
                        # sort index
